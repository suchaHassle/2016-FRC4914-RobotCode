...
public class OI {
    ...
    public double driverRT() { return driverJoystick.getRawAxis(3); }
    public double driverLT() { return driverJoystick.getRawAxis(2); }
    public double driverLJright() { 
    	if (driverJoystick.getRawAxis(0) > 0)
    		return driverJoystick.getRawAxis(0); 
    	else return 0;
    }
    public double driverLJleft() { 
    	if (driverJoystick.getRawAxis(0) < 0)
