...
public class Robot extends IterativeRobot {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        chooser.addDefault("3 second", new DriveForward(3));
        chooser.addObject("4 second", new DriveForward(4));
        chooser.addObject("5 second", new DriveForward(5));
        chooser.addObject("6 second", new DriveForward(6));
